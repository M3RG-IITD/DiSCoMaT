...
class VanillaTableBert(TableBertModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # print("VanillaTableBert", config, kwargs)
        # print("VanillaTableBert config.base_model_name", config.base_model_name)
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, masked_lm_labels=None, **kwargs):
        # TODO: See: what are BertForMaskedLM.bert and BertForMaskedLM.cls functions?
    ...
    def encode_context_and_table(
        ...
        **kwargs
        ...
        # print("flattened_column_encoding", flattened_column_encoding)
        ...
        context_encoding = torch.gather(
            ...
            dim=1,
            index=context_token_indices.unsqueeze(-1).expand(-1, -1, sequence_output.last_hidden_state.size(-1)),
        )
    ...
    def get_column_representation(
        ...
        # print("flattened_column_encoding", flattened_column_encoding)
        # print("flattened_column_encoding.last_hidden_state", flattened_column_encoding.last_hidden_state)
        ...
        result = agg_func(flattened_column_encoding.last_hidden_state,
                          column_token_to_column_id.unsqueeze(-1).expand(-1, -1, flattened_column_encoding.last_hidden_state.size(-1)),
                          dim=1,
                          dim_size=max_column_num + 1)
    ...
    def encode(
        ...
        # print("return_bert_encoding", return_bert_encoding)
