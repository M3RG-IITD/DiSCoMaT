...
class TablesDatasetReader(DatasetReader):
    ...
    def get_table_header_field(self, table_header):
        ...
        for header in table_header:
            ...
            ##table_header_field.append(tokenized_header, self._token_indexers)
    ...
    def get_table_data_field(self, table_data):
        ...
        for row in table_data:
            ...
            for cell in row:
                ...
                ##row_field.append(tokenized_cell, self._token_indexers)
